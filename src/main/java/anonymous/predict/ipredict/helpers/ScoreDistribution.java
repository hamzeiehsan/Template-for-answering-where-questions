package anonymous.predict.ipredict.helpers;
...
public class ScoreDistribution<K> {
	...
	public Double getBestDouble(double minThreshold ) {

		if(dict.size() == 0) {
			return null;
		}
		else if(dict.size() == 1) {
			return dict.lastEntry().getKey();
		}
	...
	public Double getNextDouble(double best) {
